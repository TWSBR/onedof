...
struct P_motor_T_ {
  real_T RepeatingSequenceInterpolated_O[8];
 ...
 *
 * '<Root>' : 'motor'
 * '<S1>'   : 'motor/Repeating Sequence Interpolated'
 * '<S2>'   : 'motor/Repeating Sequence Interpolated/LimitedCounter'
 * '<S3>'   : 'motor/Repeating Sequence Interpolated/LimitedCounter/Increment Real World'
 * '<S4>'   : 'motor/Repeating Sequence Interpolated/LimitedCounter/Wrap To Zero'
 */
