###########################################################################
## Makefile generated for component 'motor'. 
## 
## Makefile     : motor.mk
## Generated on : Tue Mar 19 22:39:42 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/motor.elf
...
START_DIR                 = C:/4022term/1DOF/MotorTest
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/motor.elf
...
DEFINES_STANDARD = -DMODEL=motor -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o motor.o motor_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/motor_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/motor_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/motor_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motor.o : $(START_DIR)/motor_ert_rtw/motor.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motor_data.o : $(START_DIR)/motor_ert_rtw/motor_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
