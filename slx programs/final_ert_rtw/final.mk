...
## 
## Makefile     : final.mk
## Generated on : Tue Mar 19 21:12:04 2024
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/final.elf
...
DEFINES_STANDARD = -DMODEL=final -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o MW_arduinoI2C.o io_wrappers.o final.o final_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/final_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/final_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
MW_ServoWriteRead.o : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/arduinobase/src/MW_ServoWriteRead.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/final_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final.o : $(START_DIR)/final_ert_rtw/final.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final_data.o : $(START_DIR)/final_ert_rtw/final_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/final_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/final_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/final_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
