###########################################################################
## Makefile generated for component 'gyrotest'. 
## 
## Makefile     : gyrotest.mk
## Generated on : Fri Apr 05 21:22:49 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/gyrotest.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/gyrotest.elf
...
DEFINES_STANDARD = -DMODEL=gyrotest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduinoI2C.o io_wrappers.o xcp_ext_mode.o gyrotest.o gyrotest_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/gyrotest_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/gyrotest_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/gyrotest_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/gyrotest_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


gyrotest.o : $(START_DIR)/gyrotest_ert_rtw/gyrotest.c
	$(CC) $(CFLAGS) -o "$@" "$<"


gyrotest_data.o : $(START_DIR)/gyrotest_ert_rtw/gyrotest_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
